...
function processImage(inputPath, outputPath, tolerance = 38, feather = 18) {
  ...
  for (let y = 0; y < height; y++) {
    for (let x = 0; x < width; x++) {
      ...
      if (minDistance < tolerance) {
        ...
        // Feathered edge for ultra smooth blending
...
// Process Pizza (warm orange/yellow background)
processImage(
...
// Process Burger (light cream background)
processImage(
...
// Process Delivery Scooter (yellow background)
processImage(
